 ...
 * @author ninet
 */
public class Room_add extends javax.swing.JFrame {

    /**
     * Creates new form Room_add
     */
    public Room_add() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Room_add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
